                ...
                c => new
                    {
                        ...
                        Concept = c.String(nullable: false),
                        Announcer_ID = c.Int(nullable: true),
                        DJ_ID = c.Int(nullable: true),
                        EveningManager_ID = c.Int(nullable: true),
                        EveningManagerAssistant_ID = c.Int(nullable: true),
                        IntroductoryRateGuide_ID = c.Int(nullable: true),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Active", t => t.Announcer_ID, cascadeDelete: false)
                .ForeignKey("dbo.Active", t => t.DJ_ID, cascadeDelete: false)
                .ForeignKey("dbo.Active", t => t.EveningManager_ID, cascadeDelete: false)
                .ForeignKey("dbo.Active", t => t.EveningManagerAssistant_ID, cascadeDelete: false)
                .ForeignKey("dbo.Active", t => t.IntroductoryRateGuide_ID, cascadeDelete: false)
